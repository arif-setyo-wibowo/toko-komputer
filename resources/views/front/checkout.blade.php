                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="group-inline u-s-m-b-13">
                                <div class="group-1 u-s-p-r-16">
                                    ...
                                    <input type="text" id="first-name" name="nama" class="text-field" placeholder="Nama Lengkap" value="{{ Session::get('nama.customer') }}" required>
                                </div>
                            </div>
                            <div class="u-s-m-b-13">
                                ...
                                <input type="number" id="phone" name="telp" class="text-field" placeholder="Nomor Telepon" value="{{ Session::get('telp.customer') }}" required>
                            </div>
                            ...
                            <div class="u-s-m-b-13">
                                ...
                                <input type="text" id="postcode" name="kodepos" class="text-field" class="Kode Pos" placeholder="Kode Pos" required>
                            </div>
                            <div class="group-inline u-s-m-b-13">
                                <div class="group-1 u-s-p-r-16">
                                    <input type="hidden" id="email" class="text-field" class="Email Address" placeholder="Email Address" value="{{ Session::get('email.customer') }}" required>
                                </div>
                            </div>
                        </div>
                        <!-- Billing-&-Shipping-Details /- -->
