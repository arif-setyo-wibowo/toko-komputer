                    ...
                    <div class="login-wrapper">
                        ...
                        <form action="{{ url()->current() }}" method="POST">
                            ...
                            <div class="u-s-m-b-30">
                                ...
                                <input type="text" id="user-name-email" class="text-field" name="customerEmail"
                                    placeholder=" Email">
                            </div>
                            ...
                            <div class="u-s-m-b-30">
                                ...
                                <input type="password" id="login-password" class="text-field" name="customerPassword"
                        ...
                        <div class="u-s-m-b-45 mt-1">
                            <a href="{{ route('login.google', ['provider' => 'google']) }}"><button
                                    class="button button-primary w-100 mt-1"><img src="" alt=""> Daftar atau
                                    Login dengan Google </button></a>
