                                            ...
                                            <li class="nav-item dropdown" style="list-style-type: none;">
                                                ...
                                                <ul class="p-2 dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
                                                    <li style="font-size:20px;">
                                                        <button type="button" class=" btn btn-outline-primary button-update" id="{{ $data->psuId }}"><i class="bi bi-pen"></i></button>
                                                        <button type="button" class="btn btn-outline-danger button-delete" id="{{ $data->psuId }}"><i class="bi  bi-trash"></i></button>
                                                        <button type="button" class="btn btn-outline-success button-detail" id="{{ $data->psuId }}"><i class="bi  bi-info"></i></button>
                                                    </li>
                                                    <li></li>
                                                    <li></li>
                                                </ul>
                            ...
                            <form action="{{ url()->current( )}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            ...
                                            <div class="pt-2 col-md-4 text-center">
                                                <label style="width:100px;">
                                                    <input type="file" name="psuImage" id="psuImage" style="display:none;" required>
                                ...
                                <div class="row mt-4">
                                    <div class="row col">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="psuName" id="psuName" required>
                                        </div>
                                    </div>
                                    <div class="row col">
                                    ...
                                    <div class="row col">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group ">
                                                <input type="number" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2" name="psuPower" required>
                                ...
                                <div class="row mt-4">
                                    <div class="row col ">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="psuEfficiency" required>
                                        </div>
                                    </div>
                                    <div class="row col ">
                                        <label for="inputText" class="col-md-3 col-form-label">Cooling</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="psuCooling" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    <div class="row col ">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="psuModular" required>
                                        </div>
                                    </div>
                                    <div class="row col ">
                                        <label for="inputText" class="col-md-3 col-form-label">Connector</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="psuConnector" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="row col">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="psuWarranty" required>
                                        </div>
                                    </div>
                                    <div class="row col">
                                ...
                                <div class="modal-body p-3">
                                    <form action="{{ url()->current()}}/update" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="row mb-3">
                                                <div class="col-md-8 col-lg-9">
                                                    <input type="hidden" name="idUpdate" id="idUpdate" style="display:none;">
                                                    <input type="hidden" name="imageAwal" id="imageAwal" style="display:none;">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="row col">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group ">
                                                        <input type="number" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2" name="powerUpdate" id="powerUpdate" required>
                                                        <span class="input-group-text" id="basic-addon2"> 
                                                        Watt
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Efficiency</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="efficiencyUpdate" id="efficiencyUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Cooling</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="coolingUpdate" id="coolingUpdate" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Modular</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="modularUpdate" id="modularUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Connector</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="connectorUpdate" id="connectorUpdate">
                                                </div>
                                            </div>
                                        </div>
