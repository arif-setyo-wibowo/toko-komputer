                                            ...
                                            <li class="nav-item dropdown" style="list-style-type: none;">
                                                ...
                                                <ul class="p-2 dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
                                                    <li style="font-size:20px;">
                                                        <button type="button" class=" btn btn-outline-primary button-update" id="{{ $data->gpuId }}"><i class="bi bi-pen"></i></button>
                                                        <button type="button" class="btn btn-outline-danger button-delete"  id="{{ $data->gpuId }}"><i class="bi  bi-trash"></i></button>
                                                        <button type="button" class="btn btn-outline-success button-detail"  id="{{ $data->gpuId }}"><i class="bi  bi-info"></i></button>
                                                    </li>
                                                    <li></li>
                                                    <li></li>
                                                </ul>
                            ...
                            <form action="{{ url()->current() }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            ...
                                            <div class="pt-2 col-md-4 text-center">
                                                <label style="width:100px;">
                                                    <input type="file" name="gpuImage" id="gpuImage" style="display:none;" required>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="row col ">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="gpuMemoryClockSpeed" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    <div class="row col ">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="gpuMemoryInterface" required>
                                        </div>
                                    </div>
                                    <div class="row col ">
                                    ...
                                    <div class="row col ">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group ">
                                                <input type="number" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2" name="gpuPowerReq" id="gpuPowerReq" required>
                                    ...
                                    <form action="{{ url()->current() }}/update" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    ...
                                                    <div class="pt-2 col-md-4 text-center">
                                                        <label style="width:100px;">
                                                          <input type="file" name="gpuImageUpdate" id="gpuImageUpdate" style="display:none;">
                                                          <a class="btn btn-primary " style="width: 100px;"><i class="bi bi-upload"></i></a>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col">
                                                <label for="inputText" class="col-md-3 col-form-label">Nama</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="gpuNameUpdate" id="gpuNameUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col">
                                                <label for="inputText" class="col-md-3 col-form-label">Nama Brand</label>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Interface</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="gpuInterfaceUpdate" id="gpuInterfaceUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Base Clock</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="gpuBaseClockUpdate" id="gpuBaseClockUpdate" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Boot Clock</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="gpuBoostClockUpdate" id="gpuBoostClockUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Memory Clock Speed</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="gpuMemoryClockSpeedUpdate" id="gpuMemoryClockSpeedUpdate" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Memory Size</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="gpuMemorySizeUpdate" id="gpuMemorySizeUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Memory Interface</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="gpuMemoryInterfaceUpdate" id="gpuMemoryInterfaceUpdate" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Memory Type</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="gpuMemoryTypeUpdate" id="gpuMemoryTypeUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Fitur</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="gpuFeatureUpdate" id="gpuFeatureUpdate" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col ">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group ">
                                                        <input type="number" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2" name="gpuPowerReqUpdate" id="gpuPowerReqUpdate" required>
                                                        <span class="input-group-text" id="basic-addon2"> 
                                                        Watt
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Case Support</label>
                                                <div class="col-sm-8">
                                                    <select class="form-select" name="gpuCaseSupportUpdate" id="gpuCaseSupportUpdate" required>
                                                      <option value="Mini-ITX">Mini-ITX</option>
                                                      <option value="Micro-ATX">Micro-ATX</option>
                                                      <option value="ATX">ATX</option>
                                                      <option value="Extended ATX">Extended ATX</option>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="hargaUpdate" id="hargaUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col">
                                                <label for="inputText" class="col-md-4 col-form-label">Garansi</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="garansiUpdate" id="garansiUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col">
                                                <label for="inputText" class="col-md-4 col-form-label">Stok</label>
                                                <div class="col-sm-8">
                                                    <input type="number" class="form-control" name="stokUpdate" id="stokUpdate">
                                                </div>
                                            </div>
                                        </div>
