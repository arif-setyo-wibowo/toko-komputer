                ...
                <div id="invoice">
                    ...
                    <div class="toolbar hidden-print">
                        <div class="text-right row">
                            ...
                            <div class="col-md-1">
                              <button id="printInvoice" class="btn bname#printInvoicetn-info"><i class="bx bxs-printer"></i></button>
                            </div>
                    ...
                    <div class="invoice overflow-auto">
                        <div style="min-width: 600px">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <a target="_blank" href="https://lobianijs.com">
                                            <img src="{{asset('admin/')}}/img/profile-img.jpg" data-holder-rendered="true" />
                                            </a>
                                    </div>
                          ...
                          <div class="notices">
                              <div>NOTICE:</div>
                              <div class="notice">A finance charge of 1.5% will be made on unpaid balances after 30 days. harap melakukan konfirmasi atau hubngi kami dimana saja anda berada dan jangan sngkan</div>
