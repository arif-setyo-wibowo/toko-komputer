                        ...
                        @if ((Session::get('role.karyawan')))
                            ...
                            <div class="tab-content p-2" id="borderedTabContent">
                                ...
                                <div class="tab-pane fade" id="bordered-profile" role="tabpanel"
                                    ...
                                    <h5 class="card-title">Tambah Motherboard </h5>
                                    <form action="{{ url()->current() }}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    ...
                                                    <div class="pt-2 col-md-4 text-center">
                                                        <label style="width:100px;">
                                                            <input type="file" name="moboImage" id="moboImage"
                                                                style="display:none;" required>
                                                            <a class="btn btn-primary " style="width: 100px;" required><i
                                            ...
                                            <div class="row col">
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="form-select" aria-label="Default select example"
                                                        name="processorSocketId" required>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                                <div class="accordion-item"
                                                    ...
                                                    <h2 class="accordion-header" id="flush-headingOne">
                                                        <button
                                                            style="background-color:#dee2e6; padding:20px; border-radius:5px;"
                                                ...
                                                <div class="row col" style="">
                                                    <div class="row col-md-4 ">
                                                        <div class="col-sm-6 form-check" style="padding-left:10px;">
                                                            <input type="text" class=" form-control" value="SATA"
                                                                disabled>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <select class="form-select"
                                                    ...
                                                    <div class="row col-md-4 ">
                                                        <div class="col-sm-6 form-check" style="padding-left:10px;">
                                                            <input type="text" class=" form-control" value="M.2"
                                                                disabled>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <select class="form-select"
                                            ...
                                            <div class="row mt-4">
                                                <div class="row col">
                                                    <label for="inputText" class="col-md-3 col-form-label">Memory
                                                        Type</label>
                                                    <div class="col-sm-8">
                                                        <select class="form-select" aria-label="Default select example"
                                                            name="moboMemoryType" required>
                                                            <option value="" disabled selected>Pilih Memory Type
                                                            </option>
                                                    ...
                                                    <label for="inputText" class="col-md-3 mt-3 col-form-label">Memory
                                                        Slot</label>
                                                    <div class="col-sm-8 mt-3">
                                                        <select class="form-select" aria-label="Default select example"
                                                            name="moboMemorySlot" required>
                                                            <option value="" disabled selected>Pilih Memory Slot
                                                            </option>
                                            ...
                                            <div class="row mt-4">
                                                <div class="row col">
                                                    <label for="inputText" class="col-md-3 col-form-label">Form
                                                        Factor</label>
                                                    <div class="col-sm-8">
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="row col">
                                                    ...
                                                    <div class="col-sm-8 mt-3">
                                                        <input type="number" class="form-control" name="moboStock"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Update Motherboard</h5>
                                            ...
                                            <form action="{{ url()->current() }}/update" method="POST"
                                                ...
                                                <div class="row">
                                                    <div class="row col">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-select"
                                                                aria-label="Default select example" name="socketUpdate"
                                                                id="socketUpdate" required>
                                                                <option selected value disabled>Pilih Socket</option>
                                                                @foreach ($processor as $data)
                                                                    <option value="{{ $data->processorSocketId }}">
                                                                        {{ $data->processorSocketName }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="row mt-4">
                                                    ...
                                                    <div class="row col">
                                                        <label for="inputText"
                                                            class="col-md-4 col-form-label">Chipset</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"
                                                                name="chipsetUpdate" id="chipsetUpdate" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                                    ...
                                                                    <div class="row mt-2">
                                                                        <div class="row col-md-4 ">
                                                                            <div class="col-sm-6 form-check"
                                                                                style="padding-left:10px;">
                                                                                <input type="text"
                                                                                    class=" form-control" value="USB C"
                                                                                    disabled>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <select class="form-select"
                                                                        ...
                                                                        <div class="row col-md-4 ">
                                                                            <div class="col-sm-6 form-check"
                                                                                style="padding-left:10px;">
                                                                                <input type="text"
                                                                                    class=" form-control" value="USB 2.0"
                                                                                    disabled>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <select class="form-select"
                                                                        ...
                                                                        <div class="row col-md-4 ">
                                                                            <div class="col-sm-6 form-check"
                                                                                style="padding-left:10px;">
                                                                                <input type="text"
                                                                                    class=" form-control" value="USB 3.2"
                                                                                    disabled>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <select class="form-select"
                                                                    ...
                                                                    <div class="row mt-2">
                                                                        <div class="row col-md-4 ">
                                                                            <div class="col-sm-6 form-check"
                                                                                style="padding-left:10px;">
                                                                                <input type="text"
                                                                                    class=" form-control" value="AT/PS 2"
                                                                                    disabled>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <select class="form-select"
                                                                        ...
                                                                        <div class="row col-md-4 ">
                                                                            <div class="col-sm-6 form-check"
                                                                                style="padding-left:10px;">
                                                                                <input type="text"
                                                                                    class=" form-control" value="D-sub"
                                                                                    disabled>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <select class="form-select"
                                                                        ...
                                                                        <div class="row col-md-4 ">
                                                                            <div class="col-sm-6 form-check"
                                                                                style="padding-left:10px;">
                                                                                <input type="text"
                                                                                    class=" form-control" value="S/PDIF"
                                                                                    disabled>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <select class="form-select"
                                                                    ...
                                                                    <div class="row mt-2">
                                                                        <div class="row col-md-4 ">
                                                                            <div class="col-sm-6 form-check"
                                                                                style="padding-left:10px;">
                                                                                <input type="text"
                                                                                    class=" form-control" value="Ethernet"
                                                                                    disabled>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <select class="form-select"
                                                                        ...
                                                                        <div class="row col-md-4 ">
                                                                            <div class="col-sm-6 form-check"
                                                                                style="padding-left:10px;">
                                                                                <input type="text"
                                                                                    class=" form-control" value="Firewire"
                                                                                    disabled>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <select class="form-select"
                                                                        ...
                                                                        <div class="row col-md-4 ">
                                                                            <div class="col-sm-6 form-check"
                                                                                style="padding-left:10px;">
                                                                                <input type="text"
                                                                                    class=" form-control" value="Paralel"
                                                                                    disabled>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <select class="form-select"
                                                                    ...
                                                                    <div class="row mt-2">
                                                                        ...
                                                                        <div class="row col-md-4 ">
                                                                            <div class="col-sm-6 form-check"
                                                                                style="padding-left:10px;">
                                                                                <input type="text"
                                                                                    class=" form-control" value="Audio"
                                                                                    disabled>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <select class="form-select"
                                                                    ...
                                                                    <div class="row mt-2">
                                                                        <div class="row col-md-4 ">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <select class="form-select"
                                                                                    ...
                                                                                    <option value="Display Port x 1">1
                                                                                    </option>
                                                                                    <option value="Display Port x 2">2
                                                                                    </option>
                                                                                    <option value="Display Port x 3">3
                                                                                    </option>
                                                                                    <option value="Display Port x 4">4
                                                                                    </option>
                                                                                    <option value="Display Port x 5">5
                                                                                    </option>
                                                                                    <option value="Display Port x 6">6
                                                                                    </option>
                                                                                    <option value="Display Port x 7">7
                                                                                    </option>
                                                                                    <option value="Display Port x 8">8
                                                                                    </option>
                                                                                    <option value="Display Port x 9">9
                                                                                    </option>
                                                                                    <option value="Display Port x 10">10
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row col-md-4 ">
                                                                            <div class="col-sm-6 form-check"
                                                                                style="padding-left:10px;">
                                                                                <input type="text"
                                                                                    class=" form-control" value="eSata"
                                                                                    disabled>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <select class="form-select"
                                                    ...
                                                    <div class="row col">
                                                        ...
                                                        col-md-4 ">
                                                            ...
                                                            <div class="col-md-6">
                                                                <select class="form-select"
                                                                    aria-label="Default select example"
                                                                    name="sataUpdate" id="sataUpdate" required>
                                                        ...
                                                        <div class="row col-md-4 ">
                                                            ...
                                                            <div class="col-md-6">
                                                                <select class="form-select"
                                                                    aria-label="Default select example" name="M2Update"
                                                ...
                                                <div class="row mt-4">
                                                    <div class="row col">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-select"
                                                                aria-label="Default select example" name="typeUpdate"
                                                        ...
                                                        <label for="inputText"
                                                            class="col-md-4 mt-3 col-form-label">Memory Slot</label>
                                                        <div class="col-sm-8 mt-3">
                                                            <select class="form-select"
                                                                aria-label="Default select example" name="slotUpdate"
                                                    ...
                                                    <div class="row col">
                                                        <label for="inputText" class="col-md-4 col-form-label">Max
                                                            Memory</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"
                                                                name="capUpdate" id="capUpdate" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mt-4">
                                                    <div class="row col">
                                                        <label for="inputText" class="col-md-4 col-form-label">Form
                                                            Factor</label>
                                                        <div class="col-sm-8">
                                                            <select class="form-select" name="ffUpdate" id="ffUpdate"
                                                                required>
                                                                <option value="mITX">Mini-ITX</option>
                                                                <option value="mATX">Micro-ATX</option>
                                                                <option value="ATX">ATX</option>
                                                    ...
                                                    <div class="row col">
                                                        <label for="inputText"
                                                            class="col-md-4 col-form-label">Warranty</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"
                                                ...
                                                <div class="row mt-4">
                                                    ...
                                                    <div class="row col">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"
                                                                name="stokUpdate" id="stokUpdate" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mt-4">
