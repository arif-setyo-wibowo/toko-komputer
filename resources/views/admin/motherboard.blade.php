        ...
        <div class="col-lg-12">
            ...
            <div class="col-12">
                ...
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    ...
                    <i class="bi bi-exclamation-octagon me-1"> {{ $error }} </i><br> @endforeach
                </div>
                @endif
                                            ...
                                            <li class="nav-item dropdown" style="list-style-type: none;">
                                                ...
                                                <ul class="p-2 dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
                                                    <li style="font-size:20px;">
                                                        <button type="button" class=" btn btn-outline-primary button-update" id="{{$data->moboId}}"><i class="bi bi-pen"></i></button>
                                                        <button type="button" class="btn btn-outline-danger button-hapus" id="{{$data->moboId}}"><i class="bi  bi-trash"></i></button>
                                                        <button type="button" class="btn btn-outline-success button-detail" id="{{$data->moboId}}"><i class="bi  bi-info"></i></button>
                                                    </li>
                                                    <li></li>
                                                    <li></li>
                                                </ul>
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="row col" style="padding-left:50px;">
                                            <div class="row col-md-4 ">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-select" aria-label="Default select example" name="moboStorageSata" required>
                                                        <option value="" disabled selected></option>
                                            ...
                                            <div class="row col-md-4 ">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-select" aria-label="Default select example" name="moboStorageM2" required>
                                                        <option></option>
                                        ...
                                        <form action="{{ url()->current() }}/update" method="POST" enctype="multipart/form-data" >
                                            ...
                                            <div class="row">
                                                <div class="row mb-3">
                                                    <div class="col-md-8 col-lg-9">
                                                        ...
                                                        <div class="pt-2 col-md-4 text-center">
                                                            <label style="width:100px;">
                                                                <input type="file" name="imageUpdate" id="imageUpdate" style="display:none;" required>
                                            ...
                                            <div class="row">
                                                <div class="row col">
                                                    <label for="inputText" class="col-md-3 col-form-label">Nama Socket</label>
                                                    <div class="col-sm-8">
                                                        <select class="form-select" aria-label="Default select example" name="socketUpdate" id="socketUpdate" required>
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="row col">
                                                    <label for="inputText" class="col-md-3 col-form-label">Chipset</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" name="chipsetUpdate" id="chipsetUpdate" required>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="accordion-body row mt-3" style="padding-left:30px;">
                                                                ...
                                                                <div class="row mt-2">
                                                                    <div class="row col-md-4 ">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <select class="form-select" aria-label="Default select example" name="PortUpdate[]" id="portUpdate" >
                                                                                <option value="" disabled selected></option>
                                                                                <option value="USB C x 1">1</option>
                                                                                <option value="USB C x 2">2</option>
                                                                                <option value="USB C x 3">3</option>
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="row col" style="padding-left:50px;">
                                                    <div class="row col-md-4 ">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="form-select" aria-label="Default select example" name="sataUpdate" id="sataUpdate" required>
                                                                <option value="" disabled selected></option>
                                                                <option value=" SATA x 1">1</option>
                                                                <option value="SATA x 2">2</option>
                                                                <option value="SATA x 3">3</option>
                                                    ...
                                                    <div class="row col-md-4 ">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="form-select" aria-label="Default select example" name="M2Update"  id="M2Update" required>
                                                                <option></option>
                                                                <option value="M.2 x 1">1</option>
                                                                <option value="M.2 x 2">2</option>
                                                                <option value="M.2 x 3">3</option>
                                            ...
                                            <div class="row mt-4">
                                                <div class="row col">
                                                    <label for="inputText" class="col-md-3 col-form-label">Memory Type</label>
                                                    <div class="col-sm-8">
                                                        <select class="form-select" aria-label="Default select example" name="typeUpdate" id="typeUpdate" required>
                                                            <option value="" disabled selected></option>
                                                            <option value="DDR3">DDR3</option>
                                                            <option value="DDR4">DDR4</option>
                                                            <option value="DDR5">DDR5</option>
                                                    ...
                                                    <label for="inputText" class="col-md-3 mt-3 col-form-label">Memory Slot</label>
                                                    <div class="col-sm-8 mt-3">
                                                        <select class="form-select" aria-label="Default select example" name="slotUpdate" id="slotUpdate" required>
                                                            <option value="" disabled selected></option>
                                                            <option value="1">1</option>
                                                            <option value="2">2</option>
                                                            <option value="3">3</option>
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="row col">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" name="stokUpdate" id="stokUpdate" required>
                                                    </div>
                                                </div>
                                            </div>
