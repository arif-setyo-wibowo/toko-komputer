                ...
                <form action="{{ url()->current() }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row mt-4">
                    ...
                    <div class="row col">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="nama" placeholder="Headset/Earphone/TWS" required>
                      </div>
                    </div>
                  </div>
                  <div class="row mt-4">
                  ...
                  <div class="row mt-4">
                    ...
                    <div class="row col">
                      ...
                      <div class="col-sm-8">
                        <input type="number" class="form-control" name="stok" placeholder="USB/Wireless/Bluthod" required>
                      </div>
                    </div>
                  </div>
                  <div class="row mt-4">
                      ...
                      <label class="col-sm-3 col-form-label">Microphone</label>
                        <div class="col-sm-10">
                          <div class="form-check form-switch">
                            ...
                            <label class="form-check-label" for="flexSwitchCheckDefault">pilih jika ada Mic</label>
                        </div>
                    </div>
                  </div>
                  <div class="row mt-4">
                        ...
                        <div class="">
                          ...
                          alt="">
                              ...
                              <div class="col-md-7 tab-pane fade show active profile-overview modal-dialog-scrollable"
                                id="profile-overview">
                                <h5 class="card-title" id="">GALAX XANOVA Ocala / XH200 Gaming Headset</h5>
