                                            ...
                                            <li class="nav-item dropdown" style="list-style-type: none;">
                                                ...
                                                <ul class="p-2 dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
                                                    <li style="font-size:20px;">
                                                        <button type="button" class=" btn btn-outline-primary button-update" id="{{ $data->coolerId }}"><i
                                                                    class="bi bi-pen"></i></button>
                                                        <button type="button" class="btn btn-outline-danger button-hapus" id="{{ $data->coolerId }}"><i
                                                                    class="bi  bi-trash"></i></button>
                                                        <button type="button" class="btn btn-outline-success button-detail" id="{{ $data->coolerId }}" data-bs-toggle="modal"><i
                            ...
                            <form action="{{ url()->current() }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="row col">
                                        <div class="row col">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-select" aria-label="Default select example" name="brandCooler" required>
                                ...
                                <div class="row mt-4">
                                    <div class="row col">
                                        <label for="inputText" class="col-md-3 col-form-label">Type
                                            Cooler</label>
                                        <div class="col-sm-9">
                                            <select class="form-select" aria-label="Default select example" name="coolerType" required>
                                    ...
                                    <div class="row col">
                                        <label for="inputText" class="col-md-3 col-form-label">Case
                                            Type</label>
                                        <div class="col-sm-9">
                                            <select class="form-select" aria-label="Default select example" name="coolerCaseType" required>
                                ...
                                <div class="row mt-4">
                                    <div class="row col">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-select" aria-label="Default select example" name="coolerSocket" required>
                                    ...
                                    <div class="row col ">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group ">
                                                <input type="number" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2" name="coolerWarranty" required>
                                    ...
                                    <div class="modal-body p-3">
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col">
                                                <label for="inputText" class="col-md-4 col-form-label">Type
                                                    Cooler</label>
                                                <div class="col-sm-8">
                                                    <select class="form-select" aria-label="Default select example" name="updateType" id="typeUpdate" required>
                                            ...
                                            <div class="row col">
                                                <label for="inputText" class="col-md-4 col-form-label">Case
                                                    Type</label>
                                                <div class="col-sm-8">
                                                    <select class="form-select" aria-label="Default select example" name="updateCaseType" id="caseTypeUpdate" required>
                                                        <option selected disabled value="">Pilih Case Type
                                                        </option>
                                                        <option value="Mini-ITX">Mini-ITX</option>
                                                        <option value="Micro-ATX">Micro-ATX</option>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col">
                                                <label for="inputText" class="col-md-4 col-form-label">Cooler
                                                    Speed</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="updateRpm" id="rpmUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col">
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="updateSocket" id="socketUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col">
