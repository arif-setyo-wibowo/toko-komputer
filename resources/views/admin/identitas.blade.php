          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Edit Toko</button>
                </li>
              </ul>
                  ...
                  <form action="/identitas" method="post"enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="{{asset('uploads/gambar/identitas/'.$data->shopLogo) }}" style="height: 150px;" alt="">
                        <div class="pt-2">
                          <label>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="shopName" type="text" class="form-control" id="shopName" value="{{$data->shopName}}">
                      </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="shopPhoneNumber" type="text" class="form-control" id="shopPhoneNumber" value="{{$data->shopPhoneNumber}}">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="Email" class="col-md-4 col-lg-3 col-form-label">Email Toko</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="shopEmail" type="email" class="form-control" id="shopEmail" value="{{$data->shopEmail}}">
                      </div>
                    </div>
                    @endforeach
