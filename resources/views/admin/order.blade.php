                        ...
                        <div class="tab-pane fade show active" id="bordered-home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <table class="table table-hovered datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#">#{{ substr($item->orderId, 0, 8) }}</a></th>
                                        ...
                                        <td>
                                            ...
                                            <button style="font-size :12px; width:100px; background-color:#F5CDD9; border:none ; " type="button" class="btn btn-primary rounded-pill">
                                                <div style="color:#FF5368;"> Perlu Dibayar
                                            </button>
                                            @elseif (empty($item->orderResi) && $item->orderStatus == 'Paid')
                                            <button style="font-size :12px; width:100px; background-color:#CAC9FB; border:none ; " type="button" class="btn btn-primary rounded-pill btn-resi" data-bs-target="#inputResi" data-bs-toggle="modal" data-id="{{ $item->orderId }}">
