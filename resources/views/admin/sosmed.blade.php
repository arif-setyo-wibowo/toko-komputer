                    ...
                    <div class="card recent-sales overflow-auto p-3">
                        ...
                        <div class="tab-content pt-2" id="borderedTabContent">
                            <div class="tab-pane fade show active" id="bordered-home" role="tabpanel"
                                ...
                                <h5 class="card-title">Daftar List Sosial Media</h5>
                    ...
                    <form action="{{ url()->current() }}/update" method="post">
                        ...
                        <div class="modal-body p-3">
                            <div class="row mb-6 mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" placeholder="Masukkan Nama Platform"
                                        id="mediaName" name="mediaName" required>
                                </div>
                            </div>
                            <div class="row mb-6 mb-3">
                                <label for="inputText" class="col-sm-3 col-form-label">Link Platform</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" placeholder="Masukkan Link Platform"
                                        id="medialink" name="medialink" required>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" id="buttonupdate">Ubah Data</button>
                        </div>
                    </form>
                </div>
