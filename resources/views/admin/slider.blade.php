                        ...
                        <div class="tab-pane fade show active" id="bordered-home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <table class="table table-hover datatable">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">1</th>
                                        <td><img src="{{ asset('uploads') }}/default.png" style="width:150px;"></td>
                                        <td>Banner Asus</td>
                                        <td>19-10-2023</td>
                                        <td>25-10-2023</td>
                                        <td>LAH DESKRIPSI</td>
                                            ...
                                            <li class="nav-item dropdown" style="list-style-type: none;">
                                                ...
                                                <ul class="p-2 dropdown-menu dropdown-menu-end dropdown-menu-arrow ">
                                                    <li style="font-size:20px; padding-left: 25px;" class="row">
                                                        <button type="button" class="m-1 col-4 btn btn-outline-primary buttonupdate" id="updateSlider" data-bs-target="#updateSlider" data-bs-toggle="modal"><i class="bi bi-pen"></i></button>
                                                        <button type="button" class="m-1 col-4 btn btn-outline-danger buttondelete" id=""><i class="bi  bi-trash"></i></button>
                                                    </li>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-3">
                                    <form action="{{ url()->current() }}/update" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        <div class="row mb-3">
                                            <input type="hidden" name="brandIdUpdate" id="brandIdUpdate">
                                            <label for="inputText" class="col-sm-2 col-form-label">Nama Slider</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="sliderImage" id="sliderImage" required>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="inputText" class="col-sm-2 col-form-label">Tgl Awal</label>
