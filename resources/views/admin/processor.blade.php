                                            ...
                                            <li class="nav-item dropdown" style="list-style-type: none;">
                                                ...
                                                <ul class="p-2 dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
                                                    <li style="font-size:20px;">
                                                        <button type="button" class=" btn btn-outline-primary button-update" id="{{ $data->processorId }}"><i class="bi bi-pen"></i></button>
                                                        <button type="button" class="btn btn-outline-danger button-delete" id="{{ $data->processorId }}"><i class="bi  bi-trash"></i></button>
                                                        <button type="button" class="btn btn-outline-success button-detail" id="{{ $data->processorId }}"><i class="bi  bi-info"></i></button>
                                                    </li>
                                                    <li></li>
                                                    <li></li>
                                                </ul>
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            ...
                                            <div class="pt-2 col-md-4 text-center">
                                                <label style="width:100px;">
                                                    <input type="file" name="processorImage" id="processorImage" style="display:none;" required>
                              ...
                              @endforeach
                                ...
                                <div class="row mt-4">
                                    <div class="row col ">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="processorName" required>
                                        </div>
                                    </div>
                                    <div class="row col ">
                                        <label for="inputText" class="col-md-3 col-form-label">Generation</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="processorGen" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    <div class="row col ">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="processorCore" required>
                                        </div>
                                    </div>
                                    <div class="row col ">
                                        <label for="inputText" class="col-md-3 col-form-label">Threads</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="processorThread" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    <div class="row col ">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="processorBaseSpeed" required>
                                        </div>
                                    </div>
                                    <div class="row col ">
                                        <label for="inputText" class="col-md-3 col-form-label">Boost Speed</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="processorBoostSpeed" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    <div class="row col ">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="processorCache" required>
                                        </div>
                                    </div>
                                    <div class="row col ">
                                        <label for="inputText" class="col-md-3 col-form-label">Arsitektur</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="processorArch" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    <div class="row col ">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="processorIgpu" required>
                                        </div>
                                    </div>
                                    <div class="row col ">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group ">
                                                <input type="number" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2" name="processorPower" required>
                                ...
                                <div class="row mt-4">
                                    <div class="row col ">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="processorHeatsink" required>
                                        </div>
                                    </div>
                                    <div class="row col ">
                                        <label for="inputText" class="col-md-3 col-form-label">Harga</label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" name="processorPrice" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    <div class="row col">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="processorWarranty" required>
                                        </div>
                                    </div>
                                    <div class="row col">
                                        <label for="inputText" class="col-md-3 col-form-label">Stok</label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" name="processorStock" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    ...
                                    <form action="{{ url()->current()}}/update" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    ...
                                                    <div class="pt-2 col-md-4 text-center">
                                                        <label style="width:100px;">
                                                            <input type="file" name="processorImageUpdate" id="processorImageUpdate" style="display:none;" >
                                                            <a class="btn btn-primary " style="width: 100px;"><i class="bi bi-upload"></i></a>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Processors</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="processorNameUpdate" id="processorNameUpdate" required >
                                                </div>
                                            </div>
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Generation</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="processorGenUpdate" id="processorGenUpdate" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Core</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="processorCoreUpdate" id="processorCoreUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Threads</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="processorThreadUpdate" id="processorThreadUpdate" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Base Speed</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="processorBaseSpeedUpdate" id="processorBaseSpeedUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Boost Speed</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="processorBoostSpeedUpdate" id="processorBoostSpeedUpdate" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Cache</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="processorCacheUpdate" id="processorCacheUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Arsitektur</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="processorArchUpdate" id="processorArchUpdate" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Integrated Graphics</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="processorIgpuUpdate" id="processorIgpuUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Power</label>
                                                <div class="col-sm-8">
                                                    <div class="input-group ">
                                                        <input type="number" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2" name="processorPowerUpdate" id="processorPowerUpdate" required>
                                                        <span class="input-group-text" id="basic-addon2"> 
                                                            Watt
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Heatsink</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="processorHeatsinkUpdate" id="processorHeatsinkUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col ">
                                                <label for="inputText" class="col-md-3 col-form-label">Harga</label>
                                                <div class="col-sm-8">
                                                    <input type="number" class="form-control" name="processorPriceUpdate" id="processorPriceUpdate" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="row col">
                                                <label for="inputText" class="col-md-3 col-form-label">Garansi</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="processorWarrantyUpdate" id="processorWarrantyUpdate" required>
                                                </div>
                                            </div>
                                            <div class="row col">
                                                <label for="inputText" class="col-md-3 col-form-label">Stok</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="processorStockUpdate" id="processorStockUpdate" required>
                                                </div>
                                            </div>
                                        </div>
