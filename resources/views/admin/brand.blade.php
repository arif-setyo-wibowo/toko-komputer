                    ...
                    <div class="card recent-sales overflow-auto p-3 ">
                        ...
                        <div class="tab-content p-2" id="borderedTabContent">
                            <div class="tab-pane fade show active" id="bordered-home" role="tabpanel"
                                ...
                                <h5 class="card-title">Daftar List Brand</h5>
                                    ...
                                    <tbody>
                                        @foreach ($brand as $data)
                                            <tr>
                                                ...
                                                <td><img src="{{ asset('uploads/' . $data->brandLogo) }}"
                                        ...
                                        <div class="modal-body p-3">
                                            <div class="row mb-3">
                                                ...
                                                <label for="inputText" class="col-sm-2 col-form-label">Nama
                                                    Brand</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="brandNameUpdate"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="mb-3 form-control" type="file"
                                                        name="brandLogoUpdate" id="brandLogoUpdate">
                                                </div>
