                                ...
                                <form action="{{ url()->current() }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                ...
                                                <div class="pt-2 col-md-4 text-center">
                                                    <label style="width:100px;">
                                                        <input type="file" name="storageImage" id="storageImage"
                                                            style="display:none;">
                                    ...
                                    <div class="row mt-4">
                                        <div class="row col-md-4">
                                            <label for="inputText" class="col-12 col-form-label">Read</label>
                                            <div class="input-group col-sm-12">
                                                <input type="number" class="form-control"
                                                    aria-label="Recipient's username" aria-describedby="basic-addon2"
                                                    name="storageReadSpeed" required>
                                                <span class="input-group-text" id="basic-addon2">
                                                    MB/s
                                                </span>
                                            </div>
                                        ...
                                        <div class="row col-md-4">
                                            <label for="inputText" class="col-12 col-form-label">Write</label>
                                            <div class="input-group col-sm-12">
                                                <input type="number" class="form-control"
                                                    aria-label="Recipient's username" aria-describedby="basic-addon2"
                                                    name="storageWriteSpeed" required>
                                                <span class="input-group-text" id="basic-addon2">
                                                    MB/s
                                                </span>
                                            </div>
                                        ...
                                        <div class="row col-md-4">
                                            <label for="inputText" class="col-12 col-form-label">RPM</label>
                                            <div class="input-group col-sm-12">
                                                <input type="number" class="form-control"
                                                    aria-label="Recipient's username" aria-describedby="basic-addon2"
                                                    name="storageRpm" required>
                                                <span class="input-group-text" id="basic-addon2">
                                                    RPM
                                                </span>
                                            </div>
                                        ...
                                        <div class="modal-body p-3">
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="row col">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-select" aria-label="Default select example"
                                                            name="brandId" id="brandUpdate" required>
                                                            <option disabled selected value="">Pilih Brand</option>
                                                            @foreach ($merk as $item)
                                            ...
                                            <div class="row mt-4">
                                                <div class="row col">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-select" aria-label="Default select example"
                                                            name="storageType" id="typeUpdate" required>
                                                ...
                                                <div class="row col">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group mb-3">
                                                            <input type="number" class="form-control"
                                                                aria-label="Recipient's username"
                                                                aria-describedby="basic-addon2" name="storageSize"
                                                                id="sizeUpdate" required>
                                                            <span class="input-group-text" id="basic-addon2">
                                                                <select class="form-select" name="storageSize2"
                                                                    id="sizeUpdate2" required>
                                            ...
                                            <div class="row mt-4">
                                                <div class="row col-md-4">
                                                    <label for="inputText" class="col-md-12 col-form-label">Read</label>
                                                    <div class="input-group col-sm-3">
                                                        <input type="number" class="form-control"
                                                            aria-label="Recipient's username"
                                                            aria-describedby="basic-addon2" name="storageReadSpeed"
                                                            id="readUpdate" required>
                                                        <span class="input-group-text" id="basic-addon2">
                                                            MB/s
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="row col-md-4">
                                                    <label for="inputText" class="col-md-12 col-form-label">Write</label>
                                                    <div class="input-group col-sm-3">
                                                        <input type="number" class="form-control"
                                                            aria-label="Recipient's username"
                                                            aria-describedby="basic-addon2" name="storageWriteSpeed"
                                                            id="writeUpdate" required>
                                                        <span class="input-group-text" id="basic-addon2">
                                                            MB/s
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="row col-md-4">
                                                    <label for="inputText" class="col-md-12 col-form-label">RPM</label>
                                                    <div class="input-group col-sm-3">
                                                        <input type="number" class="form-control"
                                                            aria-label="Recipient's username"
                                                            aria-describedby="basic-addon2" name="storageRpm"
                                                ...
                                                <div class="row col mt-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control"
                                                            name="storageDimension" id="dimensionUpdate" required>
                                                    </div>
                                                </div>
                                                <div class="row col mt-3">
                                                    <label for="inputText" class="col-md-3 col-form-label">Garansi</label>
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <div class="tab-content row ">
                                                            <div
                                                                ...
                                                                <img src="" alt="Profile"
                                                                    class="rounded mb-3 img-fluid" id="gambarStorage">
                                                            </div>

                                                            <div class="col-md-7 tab-pane fade show active profile-overview modal-dialog-scrollable"
                                                                id="profile-overview">

                                                                <h5 class="card-title" id="storageName">KLEVV SSD CRAS
                                                                    C920</h5>
