                    ...
                    <div class="card recent-sales overflow-auto p-3 ">
                                ...
                                <form action="{{ url()->current() }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                ...
                                                <div class="pt-2 col-md-4 text-center">
                                                    <label style="width:100px;">
                                                        <input type="file" name="keyboardImage" id="keyboardImage"
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="row col">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="keyboardType"
                                                    placeholder="Mechanical/Membran/Office" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-4">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="row col">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="keyboardFeature"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-4">
                                        <div class="row col">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="keyboardLayout"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="row col">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="keyboardConnection"
                                    ...
                                    <div class="row mt-4">
                                        <div class="row col">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="keyboardWarranty"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="row col">
                                        ...
                                        <div class="modal-body p-3">
                                                ...
                                                <div class="row col">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" name="updateType"
                                                            id="typeUpdate" placeholder="Mechanical/Membran/Office"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mt-4">
                                                <div class="row col">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="form-select" aria-label="Default select example"
                                                            name="updateSize" id="sizeUpdate" required>
                                                ...
                                                <div class="row col">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="form-select" aria-label="Default select example"
                                                            name="updateSwitch" id="switchUpdate" required>
                                                ...
                                                <div class="row mt-4">
                                                    <div class="row col">
                                                        <label for="inputText" class="col-md-4 col-form-label">Brand
                                                            Keyboard</label>
                                                        <div class="col-sm-8">
                                                            <select class="form-select"
                                                                aria-label="Default select example" name="updateBrand"
                                                                id="brandUpdate" required>
                                                                <option disabled selected value="">Pilih Brand
                                                                </option>
                                                                @foreach ($merk as $item)
                                                    ...
                                                    <div class="row col">
                                                        <label for="inputText"
                                                            class="col-md-4 col-form-label">Feature</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"
                                                                name="updateFeature" id="featureUpdate" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mt-4">
                                                    <div class="row col">
                                                        <label for="inputText" class="col-md-4 col-form-label">Keyborad
                                                            Layout</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"
                                                                name="updateLayout" id="layoutUpdate" required>
                                                        </div>
                                                    </div>
                                                    <div class="row col">
                                                        <label for="inputText"
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"
                                                                name="updateConnection" id="connectionUpdate"
                                                                placeholder="USB/Wireless/Bluthod" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mt-4">
                                                    <div class="row col">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"
                                                                name="updateWarranty" id="garansiUpdate" required>
                                                        </div>
                                                    </div>
                                                    <div class="row col">
                        ...
                        <div class="modal fade" id="detail" tabindex="-1">
                            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Detail Keyboard</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
